...
<div class="well">
    ...
    <form id="tab"	method="post" action="${url }" onsubmit="return checkform()">
        ...
        设备编号:${bean.shebei.bianhao }&nbsp;&nbsp;
          ...
          <label>更换后设备信息</label>
        设备分类名:${bean.shebei2.fenlei.fname }&nbsp;&nbsp;
        设备名:${bean.shebei2.mingchen }&nbsp;&nbsp;
        设备编号:${bean.shebei2.bianhao }&nbsp;&nbsp;
        ...
        <label>更换反馈</label>
        <textarea rows="7" cols="50" name="fankui" id="miaoshuid" readonly="readonly">${bean.fankui }</textarea>
