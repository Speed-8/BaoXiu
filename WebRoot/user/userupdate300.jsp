...
<div class="well">
    ...
    <form id="tab"	method="post" action="${url }" onsubmit="return checkform()" enctype="multipart/form-data">
       ...
       <label>联系电话</label>
        ...
        <label>性别</label>
        <input type="text" name="dianhua" id="dianhuaid" class="input-xlarge" value="${bean.xingbie }"  readonly="readonly">
        
         
        <label>生日</label>
        <input type="text" name="dianhua" id="dianhuaid" class="input-xlarge" value="${bean.shengri }"  readonly="readonly">
